...
describe('Item Tests', () => {
    ...
    describe('Item: Focus Sash', () => {
        it('should allow a Pokémon at full HP to survive a KO with 1 HP, consuming the item', async () => {
            // ARRANGE
    ...
    describe('Item: Choice Band', () => {
        it('should lock the user into the first move selected', async () => {
            // ARRANGE
            // 1. Fetch data for the Pokémon.
    ...
    describe('Item: Rocky Helmet', () => {
        it('should damage an attacker that makes contact to the user', async () => {
            // ARRANGE
            const attacker = createPokemon('Lucario', {
                maxHp: 150,
                currentHp: 150,
    ...
    describe('Item: Protective Pads', () => {
        it('should NOT damage an attacker when it makes contact', async () => {
            // ARRANGE
            const attacker = createPokemon('Lucario', {
                maxHp: 150,
                currentHp: 150,
    ...
    describe('Item: Black Sludge', () => {
        it('should heal a Poison-type user at the end of the turn', async () => {
            // ARRANGE
        ...
        it('should damage a non-Poison-type user at the end of the turn', async () => {
            // ARRANGE
    ...
    describe('Item: Eject Button', () => {
        it('should force the holder to switch out immediately after taking damage', async () => {
            // ARRANGE
            // 1. Fetch data for the Pokémon.
    ...
    describe('Item: Red Card', () => {
        it('should force the ATTACKER to switch with a random teammate', async () => {
            // ARRANGE
            // --- CORRECTED SETUP ---
    ...
    describe('Item: White Herb', () => {
        it('should activate and be consumed to restore stats after a self-lowering move', async () => {
            // ARRANGE
            const attacker = createPokemon('Lucario', {
    ...
    describe('Item: Heavy-Duty Boots', () => {
        it('should prevent hazard damage if the switching-in', async () => {
            // ARRANGE
    ...
    describe('Item: Choice Scarf', () => {
        it('should allow the user to move before a naturally faster opponent', async () => {
            // ARRANGE
